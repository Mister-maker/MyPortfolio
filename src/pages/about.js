...
const SecondPage = () => (
  <Layout>
    <SEO title="About" />
      ...
      <div class="wrapper">
          <div class="row">
            <div class="col-about-pic"><img src={Profile} alt=""/></div>
          ...
          <div class="row-2">
            <div class="col-1"><img src={Card} alt="" /></div>
            <div class="col-2"><img src={Card} alt="" /></div>
            <div class="col-3"><img src={Card} alt="" /></div>
            <div class="col-4"><img src={Card} alt="" /></div>
            <div class="col-5"><img src={Card} alt="" /></div>
            <div class="col-6"><img src={Card} alt="" /></div>
            <div class="col-7"><img src={Card} alt="" /></div>
            <div class="col-8"><img src={Card} alt="" /></div>
          </div>
      </div>
    </section> 
  </Layout>
